 ...
 */
isValidWord = function isValidWord(full_str) {
    "use strict";
...
var tests = [function () {
    console.log("init");
    init();
}, _testClickOnValidWords, _testClickOnInvalidWords, _testDragSameLine, _testDragDifferentLine, _testDragOverSelectedWord, _testDragFromSelectedWord, _testDragToSelectedWord, _testDragInvalidWord, _testSubmitResults];
